...
ActiveRecord::Schema.define(version: 20150915053153) do
  ...
  add_index "tempatures", ["py_id"], name: "index_tempatures_on_py_id", using: :btree

  add_foreign_key "tempatures", "pies"
end
